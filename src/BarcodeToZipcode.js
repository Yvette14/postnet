...
let translatetorResponse = require('./translatorResponse');
// let translatetorResponse = new translatetorResponseClass();
class barcodeToZipcode {
    ...
    printZipcodes(input) {
        let barcodesObj = this.validBarcodeFormat(input);
        ...
        return new translatetorResponse(text,type);
    }
